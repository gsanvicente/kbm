...
/// Mismos tokens de marca que `admin/lib/app/theme.dart` — duplicados a
/// propósito, no importados: por ADR-0002 estas dos apps no comparten
...
ThemeData buildKbmCardholderTheme() {
